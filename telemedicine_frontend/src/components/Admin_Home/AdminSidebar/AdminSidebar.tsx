    ...
    <div className={styles.sidebar}>
      ...
      <div className={styles.navContainer}>
        <nav className={styles.nav}>
          <ul>
            <li>
              <Link href="/admin_home/home">
                <p className={router.pathname === "/admin_home/home" ? styles.activeLink : ""}>Dashboard</p>
              </Link>
            </li>
            <li>
              <Link href="/admin_home/history">
                <p className={router.pathname === "/admin_home/history" ? styles.activeLink : ""}>App. History</p>
              </Link>
            </li>
            <li>
              <Link href="/admin_home/patients">
                <p className={router.pathname === "/admin_home/patients" ? styles.activeLink : ""}>Patients</p>
              </Link>
            </li>
            <li>
              <Link href="/admin_home/providers">
                <p className={router.pathname === "/admin_home/providers" ? styles.activeLink : ""}>Providers</p>
              </Link>
            </li>
            <li>
              <Link href="/admin_home/adminmessage">
                <p className={router.pathname === "/admin_home/adminmessage" ? styles.activeLink : ""}>Message</p>
              </Link>
            </li>
          </ul>
        </nav>
