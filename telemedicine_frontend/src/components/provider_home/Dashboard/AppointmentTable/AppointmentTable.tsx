...
import { ToggleComponents } from "../../Toggler/Toggler";
...
const AppointmentTable = () => {
  ...
  const appointmentsList = useAppSelector(
    (state: { appointments: InitialStateAppointments }) =>
      state.appointments.allProviderAppointmentsUpcoming
  );
  ...
  }, [page, rowsPerPage, searchTerm, emergencyFilter, dateRangeString,statusFilter]);
  ...
  const handlePrescribe=(appointment:Appointment)=>{
    router.push(`/provider_home/prescription/${appointment.appointmentID}?userId=${appointment.patientProfile.user.userID}&patientId=${appointment.patientProfile.patientID}&providerId=${appointment.providerProfile.providerID}`);
  }
    ...
    <Paper sx={containerStyle}>
      ...
      >
        ...
        <div style={{}}>
          ...
          {open && <ToggleComponents onClose={handleClose} />}
        </div>
      </Box>
