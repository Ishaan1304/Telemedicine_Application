...
import { ViewPrescription } from "../ViewPrescription.tsx/ViewPrescription";
...
const AppointmentHistoryComponentPatient: React.FC = () => {
  ...
  const appointmentHistoryListPatient = useAppSelector(
    (root: { appointments: InitialStateAppointments }) =>
      root.appointments.patientAppointmentHistory
  );
  

  const totalAppointmentHistoryPatient = useAppSelector(
    (root: { appointments: InitialStateAppointments }) =>
      root.appointments.patientAppointmentHistoryTotal
  );
    ...
    <Paper sx={{ border: "1px solid black", minHeight: "80%" }}>
      ...
      <TableContainer sx={{ height: "350px", overflowY: "auto" }}>
        <Table>
          ...
          <TableBody>
            {appointmentHistoryListPatient.map(
  ...
  >
    View
      ...
      <TablePagination
        ...
        component="div"
        count={totalAppointmentHistoryPatient}
        rowsPerPage={rowsPerPage}
        page={page}
...
export default AppointmentHistoryComponentPatient;
